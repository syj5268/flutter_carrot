    ...
    return Container(
        ...
        child: Row(
          children: [
            ...
            Expanded(
              //제대로된 정렬을 위해 사용 -> 배경 색 칠해보면 알 수 있음
              child: Container(
...
class MyApp extends StatelessWidget {
  ...
  final List<ListData> datas = [
    ListData("assets/images/image1.png", "jBL 사운드바", "역삼동 * 끌올 1분 전", "145000원",
        "0"),
    ListData("assets/images/image2.png", "샤넬 캐비어 블랙 클래식 폰홀더", "강남구 논현동 * 57초 전",
        "15000원", "3"),
    ListData("assets/images/image3.png", "(삼성역)에어팟 3세대 미개봉 제품 삽니다",
        "삼성동 * 끌올 2분 전", "18만원", "20"),
    ListData("assets/images/image4.png", "자라블라우스66사이즈", "역삼2동 * 끌올 50초 전",
        "2980000원", "6"),
    ListData(
        "assets/images/image5.png", "버거스올마이티 강남역점입니다", "역삼동 * 지역광고", "0원", "1"),
  ];
